...
gyro = new AnalogGyro(0);
 ...
 gyro.setSensitivity(0.007);
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        this.leftEncoder.setDistancePerPulse(2 * Math.PI * 1); // not sure what these constants should be
        this.rightEncoder.setDistancePerPulse(2 * Math.PI * 1);
    ...
    public void simulationPeriodic() {
        ...
        driveSim.setInputs(leftController.get() * RobotController.getInputVoltage(),
         ...
         SmartDashboard.putNumber("leftControllerValue", leftController.get());
         SmartDashboard.putNumber("rightControllerValue", rightController.get());
    ...
    public void drive(double leftSpeed, double rightSpeed) {
        SmartDashboard.putString(kDriveMode, "Tank Drive");
